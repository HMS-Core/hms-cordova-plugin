...
export declare function setResultTypeBcr(mLBcrCaptureConfig: MLKit.mLBcrCaptureConfig): Promise<any>;
export declare function setRecModeBcr(mLBcrCaptureConfig: MLKit.mLBcrCaptureConfig): Promise<any>;
...
export declare function icrVnCardDetector(icrVnDetectorReq: MLKit.icrVnDetectorReq): Promise<MLKit.MLVnIcrCaptureResult>;
...
export declare function icrCnCardDetector(icrCnDetectorReq: MLKit.icrCnDetectorReq): Promise<MLKit.MLCnIcrCaptureResult>;
export declare function icrLocalAnalyser(localAnalyserReq: MLKit.localAnalyserReq): Promise<MLKit.MLIcrCaptureResult>;
export declare function icrLocalAnalyserCreateIdCard(createIdCardReq: MLKit.createIdCardReq): Promise<any>;
export declare function icrLocalAnalyserStop(): Promise<any>;
export declare function startCustomizedView(userProps: MLKit.CustomViewModeRequest): Promise<MLKit.MLBankCard>;
export declare function switchLight(): Promise<void>;
export declare function getLightStatus(): Promise<any>;
