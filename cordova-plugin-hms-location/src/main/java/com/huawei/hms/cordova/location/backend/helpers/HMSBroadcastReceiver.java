...
import com.huawei.hms.cordova.location.backend.helpers.Constants.Event;
...
public class HMSBroadcastReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_PROCESS_LOCATION =
            "com.huawei.hms.location.backend.helpers.HMSBroadcastReceiver.ACTION_PROCESS_LOCATION";
    public static final String ACTION_PROCESS_IDENTIFICATION =
            "com.huawei.hms.location.backend.helpers.HMSBroadcastReceiver.ACTION_PROCESS_ACTIVITY_IDENTIFICATION";
    public static final String ACTION_PROCESS_CONVERSION =
            "com.huawei.hms.location.backend.helpers.HMSBroadcastReceiver.ACTION_PROCESS_ACTIVITY_CONVERSION";
