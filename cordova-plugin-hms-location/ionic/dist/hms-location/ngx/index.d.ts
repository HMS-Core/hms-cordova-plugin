...
export declare class HMSLocationKit extends IonicNativePlugin {
    init(): Promise<void>;
    disableLogger(): Promise<void>;
    enableLogger(): Promise<void>;
}
export declare class HMSFusedLocation extends IonicNativePlugin {
...
export declare class HMSActivityIdentification extends IonicNativePlugin {
...
export declare class HMSGeofence extends IonicNativePlugin {
