...
public class ARPluginConfigBody extends ARPluginConfigBasePointLine {
    ...
    public void copyValues(ARPluginConfigBase configBase) {
        if (configBase instanceof ARPluginConfigBody) {
            ...
            this.lightMode = configBody.lightMode;

            this.semanticMode = configBody.semanticMode;
            this.showSemanticSupportedInfo = configBody.showSemanticSupportedInfo;

            this.focusMode = configBody.focusMode;
            this.powerMode = configBody.powerMode;
            this.updateMode = configBody.updateMode;
        }
    }
}
