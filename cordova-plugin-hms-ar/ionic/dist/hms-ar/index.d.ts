...
export declare class HmsAROriginal extends IonicNativePlugin {
...
declare type ARBase = ARHand | ARFace | ARBody | ARPlane;
...
export declare enum ARHandType {
    AR_HAND_UNKNOWN = -1,
    AR_HAND_RIGHT = 0,
    AR_HAND_LEFT = 1
}
export declare enum SemanticPlaneLabel {
    PLANE_OTHER = 0,
    PLANE_WALL = 1,
    PLANE_FLOOR = 2,
    PLANE_SEAT = 3,
...
export declare enum ARCoordinateSystemType {
...
export declare const HmsAR: HmsAROriginal;