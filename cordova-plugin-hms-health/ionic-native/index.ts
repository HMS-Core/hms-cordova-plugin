 ...
 */
@Plugin({
    pluginName: "HMSHealth",
    plugin: "cordova-plugin-hms-health",
    pluginRef: "HMSHealth",
    repo: "https://github.com/HMS-Core/hms-cordova-plugin",
    platforms: ["Android"],
})
@Injectable()
export class HMSHealth extends IonicNativePlugin {
    @Cordova({ otherPromise: true })
    signIn(scopes: string[]): Promise<AuthHuaweiId> {
        return;
    }
    @Cordova({ otherPromise: true })
...
export const DeviceInfo = {
    createDeviceInfo: function createDeviceInfo(
        ...
        return HMSHealth.getPlugin().DeviceInfo.createDeviceInfo(
            createDeviceInfoReq
        );
    },
};
...
export const ActivityRecordController = {
    addActivityRecord: function addActivityRecord(
        ...
        return HMSHealth.getPlugin().ActivityRecordController.addActivityRecord(
    ...
    deleteActivityRecord: function deleteActivityRecord(
        ...
        return HMSHealth.getPlugin().ActivityRecordController.deleteActivityRecord(
    ...
    beginActivityRecord: function beginActivityRecord(
        ...
        return HMSHealth.getPlugin().ActivityRecordController.beginActivityRecord(
            activityRecordData
        );
    },
    beginBackgroundActivityRecord: function beginBackgroundActivityRecord(
        ...
        return HMSHealth.getPlugin().ActivityRecordController.beginBackgroundActivityRecord(
            activityRecordData
        );
    },
    ...
    endActivityRecord: function endActivityRecord(
        ...
        return HMSHealth.getPlugin().ActivityRecordController.endActivityRecord(
            activityRecordId
        );
    },
    ...
    endBackgroundActivityRecord: function endBackgroundActivityRecord(
        ...
        return HMSHealth.getPlugin().ActivityRecordController.endBackgroundActivityRecord(
            activityRecordId
        );
    },
    getActivityRecord: function getActivityRecord(
        ...
        return HMSHealth.getPlugin().ActivityRecordController.getActivityRecord(
            activityRecordJSON
        );
    },
};
...
export const AutoRecorderController = {
    startRecord: function startRecord(
        ...
        return HMSHealth.getPlugin().AutoRecorderController.startRecord(
            startRecordReq
        );
    },
    stopRecord: function stopRecord(
        ...
        return HMSHealth.getPlugin().AutoRecorderController.stopRecord(
            stopRecordReq
        );
    },
};
...
export const ConsentsController = {
    getPermissions: function getPermissions(
        ...
        return HMSHealth.getPlugin().ConsentsController.getPermissions(
            getPermissionsReq
        );
    },
    ...
    cancelAuthorizationAll: function cancelAuthorizationAll(
        cancelAuthAllReq: CancelAuthAllReq
    ): Promise<void> {
        return HMSHealth.getPlugin().ConsentsController.cancelAuthorizationAll(
            cancelAuthAllReq
        );
    },
    cancelAuthorization: function cancelAuthorization(
        ...
        return HMSHealth.getPlugin().ConsentsController.cancelAuthorization(
            cancelAuthReq
        );
    },
};
export const DataController = {
    ...
    readTodaySummation: function readTodaySummation(
        ...
        return HMSHealth.getPlugin().DataController.readTodaySummation(
            dataTypeStr
        );
    },
...
export const SettingsController = {
    ...
    readDataType: function readDataType(dataTypeName: string): Promise<void> {
        return HMSHealth.getPlugin().SettingsController.readDataType(
            dataTypeName
        );
    },
    ...
    requestAuthorizationIntent: function requestAuthorizationIntent(
        ...
        return HMSHealth.getPlugin().SettingsController.requestAuthorizationIntent(
            AuthReq
        );
    },
};
...
export const HealthRecordController = {
    addHealthRecord: function addHealthRecord(
        ...
        return HMSHealth.getPlugin().HealthRecordController.addHealthRecord(
            AddHRReq
        );
    },
    deleteHealthRecord: function deleteHealthRecord(
        ...
        return HMSHealth.getPlugin().HealthRecordController.deleteHealthRecord(
            DeleteHRReq
        );
    },
    getHealthRecord: function getHealthRecord(
        ...
        return HMSHealth.getPlugin().HealthRecordController.getHealthRecord(
            HRReq
        );
    },
    updateHealthRecord: function updateHealthRecord(
        ...
        return HMSHealth.getPlugin().HealthRecordController.updateHealthRecord(
            UpdateHRReq
        );
    },
};
...
export const HealthDataTypes = {
    ...
    DT_INSTANTANEOUS_BODY_TEMPERATURE_REST:
        "DT_INSTANTANEOUS_BODY_TEMPERATURE_REST",
    ...
    DT_INSTANTANEOUS_OVULATION_DETECTION:
        "DT_INSTANTANEOUS_OVULATION_DETECTION",
    DT_INSTANTANEOUS_VAGINAL_SPECKLE: "DT_INSTANTANEOUS_VAGINAL_SPECKLE",
    DT_INSTANTANEOUS_URIC_ACID: "DT_INSTANTANEOUS_URIC_ACID",
    DT_INSTANTANEOUS_URINE_ROUTINE_NITRITE:
        "DT_INSTANTANEOUS_URINE_ROUTINE_NITRITE",
    DT_INSTANTANEOUS_URINE_ROUTINE_UROBILINOGEN:
        "DT_INSTANTANEOUS_URINE_ROUTINE_UROBILINOGEN",
    DT_INSTANTANEOUS_URINE_ROUTINE_BILIRUBIN:
        "DT_INSTANTANEOUS_URINE_ROUTINE_BILIRUBIN",
    DT_INSTANTANEOUS_URINE_ROUTINE_GLUCOSE:
        "DT_INSTANTANEOUS_URINE_ROUTINE_GLUCOSE",
    ...
    POLYMERIZE_CONTINUOUS_BODY_BLOOD_PRESSURE_STATISTICS:
        "POLYMERIZE_CONTINUOUS_BODY_BLOOD_PRESSURE_STATISTICS",
    POLYMERIZE_CONTINUOUS_BODY_BLOOD_GLUCOSE_STATISTICS:
        "POLYMERIZE_CONTINUOUS_BODY_BLOOD_GLUCOSE_STATISTICS",
    POLYMERIZE_CONTINUOUS_SPO2_STATISTICS:
        "POLYMERIZE_CONTINUOUS_SPO2_STATISTICS",
    POLYMERIZE_CONTINUOUS_BODY_TEMPERATURE_STATISTICS:
        "POLYMERIZE_CONTINUOUS_BODY_TEMPERATURE_STATISTICS",
    POLYMERIZE_CONTINUOUS_SKIN_TEMPERATURE_STATISTICS:
        "POLYMERIZE_CONTINUOUS_SKIN_TEMPERATURE_STATISTICS",
    POLYMERIZE_CONTINUOUS_BODY_TEMPERATURE_REST_STATISTICS:
        "POLYMERIZE_CONTINUOUS_BODY_TEMPERATURE_REST_STATISTICS",
    POLYMERIZE_INSTANTANEOUS_CERVICAL_MUCUS:
        "POLYMERIZE_INSTANTANEOUS_CERVICAL_MUCUS",
    POLYMERIZE_INSTANTANEOUS_CERVICAL_STATUS:
        "POLYMERIZE_INSTANTANEOUS_CERVICAL_STATUS",
    POLYMERIZE_CONTINUOUS_MENSTRUAL_FLOW:
        "POLYMERIZE_CONTINUOUS_MENSTRUAL_FLOW",
    POLYMERIZE_INSTANTANEOUS_OVULATION_DETECTION:
        "POLYMERIZE_INSTANTANEOUS_OVULATION_DETECTION",
    POLYMERIZE_INSTANTANEOUS_VAGINAL_SPECKLE:
        "POLYMERIZE_INSTANTANEOUS_VAGINAL_SPECKLE",
...
export const DataType = {
    ...
    POLYMERIZE_CONTINUOUS_POWER_STATISTICS:
        "POLYMERIZE_CONTINUOUS_POWER_STATISTICS",
    POLYMERIZE_CONTINUOUS_SPEED_STATISTICS:
        "POLYMERIZE_CONTINUOUS_SPEED_STATISTICS",
