...
public final class CircleCapsule extends MapComponent<Circle> {
    ...
    void setAnimation(JSONObject json) {
        Animation animation = createAnimationSetFromJsonObject(json.optJSONObject("animation"));
    ...
    JSONObject clearAnimation() throws JSONException {
        return new JSONObject().put("value", component.clearAnimation());
    }

    private Animation createAnimationSetFromJsonObject(JSONObject json) {
        ...
        if (json.has("rotateAnimation")) {
            ...
            animation = setCommonAnimationPropertiesFromJson(animationSet, rotateAnimation, "Rotate", rotateAnimationJSONObject);
        ...
        if (json.has("alphaAnimation")) {
            ...
            animation = setCommonAnimationPropertiesFromJson(animationSet, alphaAnimation, "Alpha", alphaAnimationJSONObject);
        ...
        if (json.has("translateAnimation")) {
            ...
            animation = setCommonAnimationPropertiesFromJson(animationSet, translateAnimation, "Translate",
        ...
        if (json.has("scaleAnimation")) {
            ...
            animation = setCommonAnimationPropertiesFromJson(animationSet, scaleAnimation, "Scale", scaleAnimationJSONObject);
            animationSet.addAnimation(scaleAnimation);
        }
        return animation;
    }

    private Animation setCommonAnimationPropertiesFromJson(AnimationSet animationSet, Animation animation, String type, JSONObject json) {
