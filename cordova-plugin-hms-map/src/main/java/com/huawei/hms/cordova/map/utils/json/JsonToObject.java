...
public final class JsonToObject {
    ...
    public static CameraPosition constructCameraPosition(JSONObject json) {
        return CameraPosition.builder()
                .target(constructLatLng(json.optJSONObject("target")))
    ...
    public static LatLngBounds constructLatLngBounds(JSONObject json) {
        if (json != null && json.has("southwest") && json.has("northeast")) {
            return new LatLngBounds(constructLatLng(json.optJSONObject("southwest")), constructLatLng(json.optJSONObject("northeast")));
        }
        return null;
    }
