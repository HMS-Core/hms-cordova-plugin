...
2. Initialize **Capacitor** if haven't done before. The **`appId`** property must be same with **package_name** value of the **`agconnect-services.json`** file.
...
3. Install `HMS Map plugin` to the project.
...
Ionic - Cordova Runtime = "www/assets/your_file"
