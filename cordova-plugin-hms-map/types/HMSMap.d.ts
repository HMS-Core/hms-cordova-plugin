...
import { CameraPosition, CameraUpdate, ComputeDistanceResult, HuaweiMap, HuaweiMapOptions, LatLng, LatLngBounds, LatLngObj, LatLngListObj } from "./interfaces";
...
export declare function convertCoordinate(latLngObj: LatLngObj): Promise<LatLngObj>;
export declare function convertCoordinates(LatLngListObj: LatLngListObj): Promise<LatLngListObj[]>;
...
export declare function initialize(routePolicy?: string): Promise<void>;
