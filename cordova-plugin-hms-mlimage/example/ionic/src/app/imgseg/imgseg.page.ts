  ...
  public async getimgSegmentation() {
    var imgSegmentationInput = {
      imageSegmentationSetting: {
        isExact:false,
        analyserType: HMSMLImage.MLImageSegmentationSetting.BODY_SEG,
        scene: HMSMLImage.MLImageSegmentationScene.ALL,
        analyseMode: 1
      },
    ...
    try {
      const result = await HMSMLImage.imgSegmentation(imgSegmentationInput);
