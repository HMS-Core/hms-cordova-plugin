...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("getDocumentskew").addEventListener("click", function () { getimgPicker(); });
}, false);
...
async function documentSkewCorrectionStart() {
    ...
    try {
        const result = await HMSMLImage.documentSkewCorrectionAnalyser(documentSkewCorrectionReq);
