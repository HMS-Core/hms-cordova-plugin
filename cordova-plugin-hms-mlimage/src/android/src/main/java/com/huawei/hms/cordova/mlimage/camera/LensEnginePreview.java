...
package com.huawei.hms.cordova.mlimage.camera;
...
public class LensEnginePreview extends ViewGroup {
    ...
    public void start(final LensEngine lensEngine) throws IOException {
        if (lensEngine == null) {
            this.stop();
        }
    ...
    public void start(final LensEngine lensEngine, final GraphicOverlay overlay) throws IOException {
