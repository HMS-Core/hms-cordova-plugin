...
public class HmsLocalNotificationPicturesLoader {
    ...
    public interface Callback {
         ...
         */
        void call(Bitmap largeIconImage, Bitmap bigPictureImage, CallbackContext callback);
    }
    ...
    public void setCordovaCallBack(CallbackContext callback) {
    ...
    private void checkAllFinished() {
        ...
        if (this.count.incrementAndGet() >= 3 && this.callback != null) {
            this.callback.call(this.largeIconImage, this.bigPictureImage, this.cordovaCallBack);
        }
