...
public interface ResultCode {
    ...
    // Push rights are not enabled. Enable the service and set push service
    // parameters at AppGallery Connect.
    ...
    // No storage location is selected for the application or the storage location
    // is invalid.
    ...
    // The number of sent messages reaches the upper limit. The messages will be
    // discarded.
    String ERROR_TOO_MANY_MESSAGES = "907122043";

    // The message lifetime expires before the message is successfully sent to the
    // APP server.
     ...
     * 2. Check whether the correct certificate fingerprint is configured in
    ...
    // An error occurred during certificate fingerprint verification. Check whether
    // the correct certificate fingerprint is configured in AppGallery Connect. For
