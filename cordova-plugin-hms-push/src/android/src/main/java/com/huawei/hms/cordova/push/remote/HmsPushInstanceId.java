...
public class HmsPushInstanceId extends CordovaBaseModule {
    ...
    @HMSLog
    @CordovaMethod
    public void getToken(final CorPack corPack, JSONArray args, final Promise promise) throws ApiException, JSONException {
        String appId = AGConnectServicesConfig.fromContext(corPack.getCordova().getContext()).getString(Core.CLIENT_APP_ID);
    ...
    @HMSLog
    @CordovaMethod
    public void getTokenWithSubjectId(final CorPack corPack, JSONArray args, final Promise promise) throws JSONException, ApiException {
    ...
    @HMSLog
    @CordovaMethod
    public void deleteToken(final CorPack corPack, JSONArray args, final Promise promise) throws ApiException, JSONException {
        String appId = AGConnectServicesConfig.fromContext(corPack.getCordova().getContext()).getString(Core.CLIENT_APP_ID);
        String scope = args.optString(0,"HCM");
    ...
    @HMSLog
    @CordovaMethod
    public void deleteTokenWithSubjectId(final CorPack corPack, JSONArray args, final Promise promise) throws JSONException, ApiException {
