...
function localNotification(localNotification) {
    return (0, utils_1.asyncExec)("HMSPush", "HmsLocalNotification", [
        "localNotification",
        localNotification,
    ]);
}
...
function getNotifications() {
    return (0, utils_1.asyncExec)("HMSPush", "HmsLocalNotification", ["getNotifications"]);
}
...
function getChannels() {
    return (0, utils_1.asyncExec)("HMSPush", "HmsLocalNotification", ["getChannels"]);
}
