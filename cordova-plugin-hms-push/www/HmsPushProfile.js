...
function addProfile(type, profileId) {
    return utils_1.asyncExec('HMSPush', 'HmsPushProfile', ['addProfile', type, profileId]);
}
exports.addProfile = addProfile;
function addProfileWithSubjectId(subjectId, type, profileId) {
    return utils_1.asyncExec('HMSPush', 'HmsPushProfile', ['addProfileWithSubjectId', subjectId, type, profileId]);
}
exports.addProfileWithSubjectId = addProfileWithSubjectId;
function deleteProfile(profileId) {
    return utils_1.asyncExec('HMSPush', 'HmsPushProfile', ['deleteProfile', profileId]);
}
exports.deleteProfile = deleteProfile;
function deleteProfileWithSubjectId(subjectId, profileId) {
    return utils_1.asyncExec('HMSPush', 'HmsPushProfile', ['deleteProfileWithSubjectId', subjectId, profileId]);
}
