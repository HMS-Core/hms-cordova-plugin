...
5. Copy **hms-push** folder from **`node_modules/@hmscore/cordova-plugin-hms-push/ionic/dist`** directory to **`node_modules/@ionic-native`** directory.
...
3. Install `HMS Push Kit` to the project. You can either install the plugin through `npm` or by `downloading from HMS Core Plugin page`.
...
4. Copy **hms-push** folder from **`node_modules/@hmscore/cordova-plugin-hms-push/ionic/dist`** directory to **`node_modules/@ionic-native`** directory.
...
10. Enable Push API on AppGallery Connect.
