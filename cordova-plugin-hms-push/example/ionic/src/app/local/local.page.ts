...
export class LocalPage implements OnInit {
  ...
  initListener() {
    this.hmsPushEvent.onRemoteMessageReceived((result) => {
      ...
      this.hmsLocalNotification.localNotification({
        ...
        [this.hmsLocalNotification.Attr.message]:
          new this.hmsPush.CordovaRemoteMessage(result.msg).getDataOfMap(),
      });
    });
  ...
  defaultNotification = {
    ...
    [this.hmsLocalNotification.Attr.importance]:
      this.hmsLocalNotification.Importance.MAX,
  ...
  async localNotification() {
    this.hmsLocalNotification
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("localNotification", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("localNotification", result);
      });
  }
  ...
  async localNotificationSchedule() {
    this.hmsLocalNotification
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("localNotificationSchedule", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("localNotificationSchedule", result);
      });
  }
  ...
  async localNotificationVibrate() {
    this.hmsLocalNotification
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("localNotificationVibrate", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("localNotificationVibrate", result);
      });
  }
  ...
  async localNotificationRepeat() {
    this.hmsLocalNotification
      .localNotification({
        ...
        [this.hmsLocalNotification.Attr.subText]: this.subText,
        [this.hmsLocalNotification.Attr.tag]: this.tagText,
        [this.hmsLocalNotification.Attr.repeatType]:
          this.hmsLocalNotification.RepeatType.MINUTE,
      })
      .then((result: any) => {
        this.defaultSuccessHandler("localNotificationRepeat", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("localNotificationRepeat", result);
      });
  }
  ...
  async localNotificationSound() {
    this.hmsLocalNotification
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("localNotificationSound", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("localNotificationSound", result);
      });
  }
  ...
  async localNotificationOngoing() {
    this.hmsLocalNotification
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("localNotificationOngoing", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("localNotificationOngoing", result);
      });
  }
  ...
  async localNotificationBigImage() {
    this.hmsLocalNotification
      .localNotification({
        ...
        [this.hmsLocalNotification.Attr.subText]: this.subText,
        [this.hmsLocalNotification.Attr.tag]: this.tagText,
        [this.hmsLocalNotification.Attr.bigPictureUrl]:
          "https://www-file.huawei.com/-/media/corp/home/image/logo_400x200.png",
      })
      .then((result: any) => {
        this.defaultSuccessHandler("localNotificationBigImage", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("localNotificationBigImage", result);
      });
  }
  ...
  async cancelAllNotifications() {
    this.hmsLocalNotification
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("cancelAllNotifications", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("cancelAllNotifications", result);
      });
  }
  ...
  async cancelNotifications() {
    this.hmsLocalNotification
      .cancelNotifications()
      .then((result: any) => {
        this.defaultSuccessHandler("cancelNotifications", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("cancelNotifications", result);
      });
  }
  ...
  async cancelScheduledNotifications() {
    this.hmsLocalNotification
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("cancelScheduledNotifications", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("cancelScheduledNotifications", result);
      });
  }
  ...
  async cancelNotificationsWithTag() {
    ...
    this.hmsLocalNotification
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("cancelNotificationsWithTag", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("cancelNotificationsWithTag", result);
      });
  }
  ...
  async getNotifications() {
    this.hmsLocalNotification
      .getNotifications()
      .then((result: any) => {
        this.defaultSuccessHandler("getNotifications", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("getNotifications", result);
      });
  }
  ...
  async getScheduledNotifications() {
    this.hmsLocalNotification
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("getScheduledNotifications", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("getScheduledNotifications", result);
      });
  }
  ...
  async getChannels() {
    this.hmsLocalNotification
      .getChannels()
      .then((result: any) => {
        this.defaultSuccessHandler("getChannels", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("getChannels", result);
      });
  }
  ...
  async channelExists() {
    this.hmsLocalNotification
      ...
      .catch((result: any) => {
        this.defaultExceptionHandler("channelExists", result);
      });
  }
  ...
  async channelBlocked() {
    this.hmsLocalNotification
      ...
      .catch((result: any) => {
        this.defaultExceptionHandler("channelBlocked", result);
      });
  }
  ...
  async deleteChannel() {
    this.hmsLocalNotification
      ...
      .catch((result: any) => {
        this.defaultExceptionHandler("deleteChannel", result);
      });
  }
