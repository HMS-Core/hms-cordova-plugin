...
export class HomePage {
  ...
  async turnOnPush() {
    this.hmsPush
      .turnOnPush()
      .then((result: any) => {
        this.defaultSuccessHandler("turnOnPush", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("turnOnPush", result);
      });
  }
  ...
  async turnOffPush() {
    this.hmsPush
      .turnOffPush()
      .then((result: any) => {
        this.defaultSuccessHandler("turnOffPush", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("turnOffPush", result);
      });
  }
  ...
  async getID() {
    this.hmsPush
      .getId()
      .then((result: any) => {
        this.defaultSuccessHandler("getId", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("getId", result);
      });
  }
  ...
  async getAAID() {
    this.hmsPush
      .getAAID()
      .then((result: any) => {
        this.defaultSuccessHandler("getAAID", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("getAAID", result);
      });
  }
  ...
  async getToken() {
    this.hmsPush
      .getToken()
      .then((result: any) => {
        this.defaultSuccessHandler("getToken", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("getToken", result);
      });
  }
  ...
  async getCreationTime() {
    this.hmsPush
      .getCreationTime()
      .then((result: any) => {
        this.defaultSuccessHandler("getCreationTime", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("getCreationTime", result);
      });
  }
  ...
  async deleteAAID() {
    this.hmsPush
      .deleteAAID()
      .then((result: any) => {
        this.defaultSuccessHandler("deleteAAID", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("deleteAAID", result);
      });
  }
  ...
  async deleteToken() {
    this.hmsPush
      .deleteToken()
      .then((result: any) => {
        this.defaultSuccessHandler("deleteToken", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("deleteToken", result);
      });
  }
  ...
  async subscribe() {
    this.hmsPush
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("subscribe", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("subscribe", result);
      });
  }
  ...
  async unsubscribe() {
    this.hmsPush
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("unsubscribe", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("unsubscribe", result);
      });
  }
  ...
  async disableAutoInit() {
    this.hmsPush
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("disableAutoInit", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("disableAutoInit", result);
      });
  }
  ...
  async enableAutoInit() {
    this.hmsPush
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("enableAutoInit", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("enableAutoInit", result);
      });
  }
  ...
  async isAutoInitEnabled() {
    this.hmsPush
      .isAutoInitEnabled()
      .then((result: any) => {
        this.defaultSuccessHandler("isAutoInitEnabled", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("isAutoInitEnabled", result);
      });
  }
  ...
  async sendRemoteMessage() {
    this.hmsPush
      .sendRemoteMessage({
        ...
        [this.hmsPush.RemoteMessageBuilder.DATA]: {
          key1: "test",
          message: "huawei-test",
        },
      })
      .then((result: any) => {
        this.defaultSuccessHandler("sendRemoteMessage", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("sendRemoteMessage", result);
      });
  }
  ...
  async getOdid() {
    this.hmsPush
      .getOdid()
      .then((result: any) => {
        this.defaultSuccessHandler("getOdid", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("getOdid", result);
      });
  }
  ...
  async getInitialNotification() {
    this.hmsPush
      ...
      .then((result: any) => {
        this.defaultSuccessHandler("getInitialNotification", result);
      })
      .catch((result: any) => {
        this.defaultExceptionHandler("getInitialNotification", result);
      });
  }
