...
@Plugin({
  ...
  plugin: 'com-plugin-hms-push', // npm package name, example: cordova-plugin-camera
  pluginRef: 'HmsLocalNotification', // the variable reference to call the plugin, example: navigator.geolocation
  platforms: ['Android'] // Array of platforms supported, example: ['Android', 'iOS']
})
@Injectable()
...
export class CordovaRemoteMessage {
