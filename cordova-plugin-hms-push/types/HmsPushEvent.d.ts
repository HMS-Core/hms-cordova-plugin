...
export declare function onMultiSenderTokenReceivedEvent(
  callback: () => void
): void;
export declare function onMultiSenderTokenErrorEvent(
  callback: () => void
): void;
export declare const REMOTE_DATA_MESSAGE_RECEIVED =
...
export declare const LOCAL_NOTIFICATION_ACTION_EVENT =
...
export declare const ON_PUSH_MESSAGE_SENT_DELIVERED =
  "ON_PUSH_MESSAGE_SENT_DELIVERED";
export declare const ON_MULTI_SENDER_TOKEN_ERROR_EVENT =
  "ON_MULTI_SENDER_TOKEN_ERROR_EVENT";
export declare const ON_MULTI_SENDER_TOKEN_RECEIVED_EVENT =
