...
export declare class MultiProcessorOriginal extends IonicNativePlugin {
    Colors: typeof Colors;
    ScanTypes: typeof ScanTypes;
    RectStyle: typeof RectStyle;
    Permission: typeof HMSPermission;
...
export declare class CustomViewOriginal extends IonicNativePlugin {
    Colors: typeof Colors;
    ScanTypes: typeof ScanTypes;
    RectStyle: typeof RectStyle;
    Permission: typeof HMSPermission;
...
export declare const HMSScan: HMSScanOriginal;
export declare const MultiProcessor: MultiProcessorOriginal;
export declare const CustomView: CustomViewOriginal;