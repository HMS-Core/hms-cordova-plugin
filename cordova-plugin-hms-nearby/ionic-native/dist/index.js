...
var HMSNearbyOriginal = /** @class */ (function (_super) {
    ...
    * @returns Promise<void>
    */
    HMSNearbyOriginal.prototype.startWifiShare = function (wifiSharePolicy) { return cordova(this, "startWifiShare", { "otherPromise": true }, arguments); };
    /**
    * Disables the Wi-Fi sharing function.
    * @returns Promise<void>
    */
    HMSNearbyOriginal.prototype.stopWifiShare = function () { return cordova(this, "stopWifiShare", { "otherPromise": true }, arguments); };
    /**
    * Shares Wi-Fi with a remote device.
    * @param {string} endpointId ID of the remote endpoint.
    * @returns Promise<void>
    */
    HMSNearbyOriginal.prototype.shareWifiConfig = function (endpointId) { return cordova(this, "shareWifiConfig", { "otherPromise": true }, arguments); };
    /**
