...
export function getContactDetail(token: string): Promise<ContactDetail[]> {
    return asyncExec("HMSContactShield", "ContactShieldModule", [
        "getContactDetail",
        token ? token : "",
    ]);
}
...
export function startContactShieldNoPersistent(
...
export function putSharedKeyFilesOld(
...
export function getStatus(): Promise<ContactShieldStatus> {
...
export function setSharedKeysDataMapping(
...
export function getDailySketch(
...
export function putSharedKeyFilesKeys(
...
export function putSharedKeyFilesKeysProvider(
