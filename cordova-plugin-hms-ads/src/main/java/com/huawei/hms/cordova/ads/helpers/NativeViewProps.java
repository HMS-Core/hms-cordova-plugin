...
public class NativeViewProps {
    ...
    public NativeViewProps width(int width) {
    ...
    public NativeViewProps height(int height) {
    ...
    public NativeViewProps paddingLeft(int paddingLeft) {
    ...
    public NativeViewProps paddingTop(int paddingTop) {
    ...
    public NativeViewProps borderLeft(int borderLeft) {
    ...
    public NativeViewProps borderTop(int borderTop) {
    ...
    public NativeViewProps position(JSONObject json) throws JSONException {
