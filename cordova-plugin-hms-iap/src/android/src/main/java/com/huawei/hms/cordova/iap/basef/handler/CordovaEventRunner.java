...
public class CordovaEventRunner {
    ...
    private String buildJSEventParameters(final Object... objects) {
        ...
        for (final Object obj : objects) {
            if (!isToStringValueValid(obj)) {
                Log.w(CordovaEventRunner.TAG, toStrNotValidErr);
            }
    ...
    private boolean isToStringValueValid(final Object object) {
        final String originalToStr = object.getClass().getSimpleName() + "@" + Integer.toHexString(object.hashCode());
        final String currentToStr = object.toString();
