 ...
 */
export declare class HMSInAppPurchases extends AwesomeCordovaNativePlugin {
    /**
     ...
     */
    createPurchaseIntent(purchaseIntentReq: PurchaseIntentReq): Promise<PurchaseResultInfo>;
    /**
