...
10. After activating these products, put ids and descriptions of products in **`PRODUCTS`** variable on **`index.js`** file like below.
...
13. After activating these products, put ids and descriptions of products in **`PRODUCTS`** variable on **`index.js`** file like below.
