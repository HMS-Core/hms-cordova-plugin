...
export async function imageClassificationAnalyser(
    ...
    return asyncExec(
        ...
        "ACTION_IMAGE_CLASSIFICATION_ANALYSER",
        [imageClassificationReq]
    );
}
export async function stopImageClassificationAnalyser(): Promise<string> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_CLOSE_IMAGE_CLASSIFICATION_ANALYSER",
        []
    );
}
export async function imgSegmentation(
    ...
    return asyncExec("HMSImageServiceProvider", "ACTION_IMAGE_SEGMENTATION", [
        imgSegmentationReq,
    ]);
}
...
export async function objectAnalyser(
    ...
    return asyncExec("HMSImageServiceProvider", "ACTION_OBJECT_ANALYSER", [
        objectReq,
    ]);
}
export async function stillSceneAnalyser(
    ...
    return asyncExec("HMSImageServiceProvider", "ACTION_STILL_SCENE_ANALYSE", [
        stillSceneReq,
    ]);
}
...
export async function textImageSuperResolution(
    ...
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_TEXTIMAGE_SUPER_RESOLUTION_ANALYSE",
...
export async function imageSuperResolution(
    ...
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_IMAGE_SUPER_RESOLUTION_ANALYSE",
...
export async function productAnalyserStop(): Promise<any> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_PRODUCT_VISION_ANALYSE_STOP",
        []
    );
}
export async function docSkewAnalyserStop(): Promise<any> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_DOCUMENT_SKEW_ANALYSE_STOP",
        []
    );
}
export async function ISRAnalyserStop(): Promise<any> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_IMAGE_SUPER_RESOLUTION_ANALYSE_STOP",
        []
    );
}
export async function TISRAnalyserStop(): Promise<any> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_TEXTIMAGE_SUPER_RESOLUTION_ANALYSE_STOP",
        []
    );
}
export async function stillSceneAnalyserStop(): Promise<any> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_STILL_SCENE_ANALYSE_STOP",
        []
    );
}
export async function getImageClassificationAnalyserSetting(): Promise<any> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_GET_IMAGE_CLASSIFICATION_ANALYSER_SETTING",
        []
    );
}
export async function getISRSetting(): Promise<any> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_IMAGE_SUPER_RESOLUTION_ANALYSE_SETTING",
        []
    );
}
export async function getSegmentationSetting(): Promise<any> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_GET_IMAGE_SEGMENTATION_SETTING",
        []
    );
}
export async function getLandmarkSetting(): Promise<any> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_IMAGE_LANDMARK_ANALYSE_SETTING",
        []
    );
}
export async function getObjectSetting(): Promise<any> {
    return asyncExec(
        "HMSImageServiceProvider",
        "ACTION_OBJECT_ANALYSER_SETTING",
        []
    );
}
