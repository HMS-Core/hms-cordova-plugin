...
export async function localTranslator(
    ...
    return asyncExec("HMSVoiceServiceProvider", "ACTION_LOCAL_TRANSLATOR", [
        localTranslateReq,
    ]);
}
export async function remoteTranslator(
    ...
    return asyncExec("HMSVoiceServiceProvider", "ACTION_REMOTE_TRANSLATOR", [
        remotetranslateReq,
    ]);
}
...
export async function localLangDetection(
    ...
    return asyncExec("HMSVoiceServiceProvider", "ACTION_LOCAL_LANG_DETECTION", [
...
export async function translatorDownloadModel(
    ...
    return asyncExec("HMSVoiceServiceProvider", "ACTION_DOWNLOAD_MODEL", [
...
export async function translatorDeleteModel(
    ...
    return asyncExec("HMSVoiceServiceProvider", "ACTION_DELETE_MODEL", [
        deleteTranslateReq,
    ]);
}
export async function translatorLocalAllLang(
    ...
    return asyncExec("HMSVoiceServiceProvider", "ACTION_LOCAL_GETLANG", [
        localAllLangReq,
    ]);
}
export async function translatorRemoteAllLang(
    ...
    return asyncExec("HMSVoiceServiceProvider", "ACTION_REMOTE_GETLANG", [
        remoteAllLangReq,
    ]);
}
export async function stopTranslatorService(): Promise<any> {
    return asyncExec(
        "HMSVoiceServiceProvider",
        "ACTION_STOP_TRANSLATOR_SERVICE",
        []
    );
}
...
export async function stopLangDetectionService(): Promise<any> {
    return asyncExec(
        "HMSVoiceServiceProvider",
        "ACTION_STOP_LANGDETECTION_SERVICE",
        []
    );
}
export async function syncFirstBestDetect(
    ...
    return asyncExec("HMSVoiceServiceProvider", "ACTION_SYNC_FIRST_DETECT", [
        syncRequest,
    ]);
}
export async function syncProbabilityDetect(
    ...
    return asyncExec(
        "HMSVoiceServiceProvider",
        "ACTION_SYNC_PROBABILITY_DETECT",
        [syncRequest]
    );
}
...
export async function soundDectAnalyser(
    ...
    return asyncExec("HMSVoiceServiceProvider", "ACTION_SOUNDDECT_ANALYSE", [
        soundDectReq,
    ]);
}
...
export async function ttsAnalyserEngineSetting(
    ...
    return asyncExec(
        "HMSVoiceServiceProvider",
        "ACTION_TTS_ANALYSE_ENGINESETTING",
        [ttsEngineReq]
    );
}
...
export async function ttsAnalyserSetPLayerVolume(
    ...
    return asyncExec(
        "HMSVoiceServiceProvider",
        "ACTION_TTS_ANALYSE_SETPLAYER_VOLUME",
        [ttsEngineReq]
    );
}
...
export async function asrAnalyserGetLanguages(): Promise<any> {
    return asyncExec(
        "HMSVoiceServiceProvider",
        "ACTION_ASR_ANALYSE_GET_LANGUAGES",
        []
    );
}
...
export async function soundDectAnalyserDestroy(): Promise<any> {
    return asyncExec(
        "HMSVoiceServiceProvider",
        "ACTION_SOUNDDECT_ANALYSE_DESTROY",
        []
    );
}
...
export async function ttsOfflineAnalyser(
    ...
    return asyncExec("HMSVoiceServiceProvider", "ACTION_TTS_OFFLINE_ANALYSE", [
        ttsReq,
    ]);
}
...
export async function getLongAftLanguages(): Promise<any> {
    return asyncExec("HMSVoiceServiceProvider", "ACTION_LONG_AFT_LANGUAGE", []);
}
export async function getShortAftLanguages(): Promise<any> {
    return asyncExec(
        "HMSVoiceServiceProvider",
        "ACTION_GET_SHORTAFT_LANGUAGE",
        []
    );
}
...
export function asrAnalyser(
    ...
    exec(success, error, "HMSVoiceServiceProvider", "ACTION_ASR_ANALYSE", [
        asrReq,
    ]);
}
export function rttAnalyserStart(
    ...
    exec(success, error, "HMSVoiceServiceProvider", "ACTION_RTT_ANALYSE", [
        rttReq,
    ]);
}
