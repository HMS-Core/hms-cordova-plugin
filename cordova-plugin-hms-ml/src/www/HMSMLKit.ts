...
export async function hasPermissions(
    ...
    return asyncExec("HMSMLPlugin", "ACTION_CHECK_PERMISSION", [
        permissionListReq,
    ]);
}
export async function requestPermissions(
    ...
    return asyncExec("HMSMLPlugin", "ACTION_REQUEST_PERMISSION", [
        permissionListReq,
    ]);
}
...
export async function customModelAnalyser(
    ...
    return asyncExec("HMSMLPlugin", "ACTION_CUSTOMMODEL_ANALYSER", [
        customModelReq,
    ]);
}
