...
export async function imageTextAnalyser(
    ...
    return asyncExec("HMSTextServiceProvider", "ACTION_IMAGE_TEXT_ANALYSER", [
        ImageTextReq,
    ]);
}
...
export async function bankCardDetector(
    ...
    return asyncExec("HMSTextServiceProvider", "ACTION_BANK_CARD_DETECTOR", [
        bankCardDetecterReq,
    ]);
}
...
export async function formRecognitionAnalyser(
    ...
    return asyncExec("HMSTextServiceProvider", "ACTION_FORM_RECOGNITION", [
...
export async function icrVnCardDetector(
    ...
    return asyncExec("HMSTextServiceProvider", "ACTION_ICRVN_PLUGIN_DETECTOR", [
        icrVnDetectorReq,
    ]);
}

export async function icrVnCardCreate(): Promise<any> {
    return asyncExec("HMSTextServiceProvider", "ACTION_ICRVN_CREATE", []);
}

export async function getIcrVnCapture(): Promise<any> {
    return asyncExec("HMSTextServiceProvider", "ACTION_ICRVN_CAPTURE", []);
}

export async function geticrVnCardInstance(): Promise<any> {
    return asyncExec("HMSTextServiceProvider", "ACTION_ICRVN_GET_INSTANCE", []);
}

export async function icrCnCardCreate(): Promise<any> {
    return asyncExec("HMSTextServiceProvider", "ACTION_ICRCN_CREATE", []);
}

export async function geticrCnCardInstance(): Promise<any> {
    return asyncExec("HMSTextServiceProvider", "ACTION_ICRCN_GET_INSTANCE", []);
}

export async function getIcrCnCapture(): Promise<any> {
    return asyncExec("HMSTextServiceProvider", "ACTION_ICRCN_CAPTURE", []);
}

export async function icrCnCardDetector(
    icrCnDetectorReq: MLKit.icrCnDetectorReq
): Promise<MLKit.MLCnIcrCaptureResult> {
    return asyncExec("HMSTextServiceProvider", "ACTION_ICRCN_PLUGIN_DETECTOR", [
        icrCnDetectorReq,
    ]);
}
...
export async function icrLocalAnalyser(
    ...
    return asyncExec("HMSTextServiceProvider", "ACTION_LOCAL_ANALYSER", [
        localAnalyserReq,
    ]);
}
...
export async function icrLocalAnalyserCreateIdCard(
    ...
    return asyncExec("HMSTextServiceProvider", "ACTION_LOCAL_ANALYSER_CREATE", [
        createIdCardReq,
    ]);
}
