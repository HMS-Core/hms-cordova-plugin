...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("getImageScenePicker").addEventListener("click", function () { getimgPicker("imageSceneOriginal"); });
}, false);
...
async function getimgScene() {
    ...
    try {
        alert(JSON.stringify(await HMSImageServiceProvider.stillSceneAnalyser(stillSceneReq)));
    } catch (Ex) {
