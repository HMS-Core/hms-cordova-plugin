...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("getTextImageSuperPicker").addEventListener("click", function () { getimgPicker("imageSuperOriginal"); });
}, false);
...
async function getTextImageSuper() {
    ...
    try {
        const result = await HMSImageServiceProvider.textImageSuperResolution(textImageSuperResolutionReq)
