...
function imageTextAnalyser(ImageTextReq) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_IMAGE_TEXT_ANALYSER", [
            ImageTextReq,
        ]);
    });
}
...
function stopTextAnalyser() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_STOP_TEXT_ANALYSER", []);
    });
}
exports.stopTextAnalyser = stopTextAnalyser;
function getTextAnalyserInfo() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_GET_IMAGE_TEXT_INFO", []);
    });
}
exports.getTextAnalyserInfo = getTextAnalyserInfo;
function documentImageAnalyser(documentImageReq) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_DOCUMENT_IMAGE_ANALYSER", [documentImageReq]);
    });
}
exports.documentImageAnalyser = documentImageAnalyser;
function closeDocumentImageAnalyser() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_CLOSE_DOCUMENT_IMAGE_ANALYSER", []);
    });
}
exports.closeDocumentImageAnalyser = closeDocumentImageAnalyser;
function stopDocumentImageAnalyser() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_STOP_DOCUMENT_IMAGE_ANALYSER", []);
    });
}
exports.stopDocumentImageAnalyser = stopDocumentImageAnalyser;
function getDocumentImageAnalyserSetting() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_GET_DOCUMENT_IMAGE_ANALYSER_SETTING", []);
    });
}
exports.getDocumentImageAnalyserSetting = getDocumentImageAnalyserSetting;
function getTextAnalyserSetting() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_GET_IMAGE_TEXT_SETTING", []);
    });
}
exports.getTextAnalyserSetting = getTextAnalyserSetting;
function getGCRSetting() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_GET_GCR_SETTING", []);
    });
}
exports.getGCRSetting = getGCRSetting;
function stopFormRecognitionAnalyser() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_FORM_RECOGNITION_STOP", []);
    });
}
exports.stopFormRecognitionAnalyser = stopFormRecognitionAnalyser;
function bankCardDetector(bankCardDetecterReq) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_BANK_CARD_DETECTOR", [
            bankCardDetecterReq,
        ]);
    });
}
...
function stopBankCardDetector() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_STOP_BANK_CARD_DETECTOR", []);
    });
}
exports.stopBankCardDetector = stopBankCardDetector;
function setResultCallbackBcr() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_BANK_CARD_SET_RESULT_CALLBACK", []);
    });
}
exports.setResultCallbackBcr = setResultCallbackBcr;
function setResultTypeBcr(mLBcrCaptureConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_BANK_CARD_SET_RESULT_TYPE", []);
    });
}
exports.setResultTypeBcr = setResultTypeBcr;
function setRecModeBcr(mLBcrCaptureConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_BANK_CARD_SET_RECMODE", []);
    });
}
exports.setRecModeBcr = setRecModeBcr;
function getBankCardDetectorSetting() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_GET_BANK_CARD_SETTING", []);
    });
}
exports.getBankCardDetectorSetting = getBankCardDetectorSetting;
function generalCardDetector(generalCardDetectorReq) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_GENERALCARD_PLUGIN_DETECTOR", [generalCardDetectorReq]);
    });
}
exports.generalCardDetector = generalCardDetector;
function formRecognitionAnalyser(formRecognizerAnalyserReq) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_FORM_RECOGNITION", [
...
function icrVnCardDetector(icrVnDetectorReq) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_ICRVN_PLUGIN_DETECTOR", [
            icrVnDetectorReq,
        ]);
    });
}
...
function icrVnCardCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_ICRVN_CREATE", []);
    });
}
exports.icrVnCardCreate = icrVnCardCreate;
function getIcrVnCapture() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_ICRVN_CAPTURE", []);
    });
}
exports.getIcrVnCapture = getIcrVnCapture;
function geticrVnCardInstance() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_ICRVN_GET_INSTANCE", []);
    });
}
exports.geticrVnCardInstance = geticrVnCardInstance;
function icrCnCardCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_ICRCN_CREATE", []);
    });
}
exports.icrCnCardCreate = icrCnCardCreate;
function geticrCnCardInstance() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_ICRCN_GET_INSTANCE", []);
    });
}
exports.geticrCnCardInstance = geticrCnCardInstance;
function getIcrCnCapture() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_ICRCN_CAPTURE", []);
    });
}
exports.getIcrCnCapture = getIcrCnCapture;
function icrCnCardDetector(icrCnDetectorReq) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_ICRCN_PLUGIN_DETECTOR", [
            icrCnDetectorReq,
        ]);
    });
}
...
function icrLocalAnalyser(localAnalyserReq) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_LOCAL_ANALYSER", [
            localAnalyserReq,
        ]);
    });
}
...
function icrLocalAnalyserCreateIdCard(createIdCardReq) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_LOCAL_ANALYSER_CREATE", [
            createIdCardReq,
        ]);
    });
}
...
function icrLocalAnalyserStop() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.asyncExec)("HMSTextServiceProvider", "ACTION_LOCAL_ANALYSER_STOP", []);
    });
}
