...
function enableLogger() {
  return (0, utils_1.asyncExec)(className, moduleName, ["enableLogger"]);
}
exports.enableLogger = enableLogger;
function disableLogger() {
  return (0, utils_1.asyncExec)(className, moduleName, ["disableLogger"]);
}
exports.disableLogger = disableLogger;
function gotoSearchActivity(apiKey, searchFilter, hint) {
  return (0, utils_1.asyncExec)(className, moduleName, [
    "gotoSearchActivity",
    apiKey,
    searchFilter,
    hint,
...
class SearchServiceFactory {
  ...
  static create(apiKey) {
    return __awaiter(this, void 0, void 0, function* () {
      return (0, utils_1.asyncExec)(className, moduleName, ["init", apiKey])
        .then((val) => new SearchServiceImpl())
        .catch((err) => {
          throw new ApiKeyException("api key is wrong.");
        });
    });
  }
}
...
class SearchServiceImpl {
  ...
  exec(args) {
    return (0, utils_1.asyncExec)(className, moduleName, args);
  }
}
