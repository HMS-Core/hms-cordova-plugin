...
3. Install `HMS Site plugin` to the project.

   ```bash
   ionic cordova plugin add @hmscore/cordova-plugin-hms-site
   ```

4. Install HMS Site Ionic Native wrappers
...
plugins. If ProGuard is enabled in your project, the Huawei Cordova Site plugin's ProGuard rules
