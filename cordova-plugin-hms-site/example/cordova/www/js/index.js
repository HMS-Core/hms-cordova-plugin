...
function onDeviceReady() {
  document
    ...
    .addEventListener("click", textSearch, false);
  document
    .getElementById("detail-search")
    .addEventListener("click", detailSearch, false);
  document
    .getElementById("nearby-search")
    .addEventListener("click", nearbySearch, false);
  document
    .getElementById("query-suggestion")
    .addEventListener("click", querySuggestion, false);
  document
    .getElementById("query-autocomplete")
    .addEventListener("click", queryAutocomplete, false);

  document
    .getElementById("goto-activity")
    .addEventListener("click", gotoSearchActivity, false);
...
function queryAutocomplete() {
  ...
  searchService
    .queryAutocomplete(queryAutocompleteReq)
    .then((response) => log(response))
    .catch((error) => log(error));
  alert("loading");
}
