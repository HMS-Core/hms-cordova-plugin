 ...
 * @name Hms Site
 * @description
 * Cordova Site Plugin enables communication between the HMS Core Site SDK and Cordova platform. This plugin demonstrates wide-ranging functionality of the HMS Core Site SDK.
 *
 * @usage
 * ```typescript
 * import { HmsSite } from '@ionic-native/hms-site';
 *
 *
 ...
 *
 *
 * this.hmsSite.textSearch(SearchRequest)
...
@Plugin({
  pluginName: 'HmsSite',
  plugin: 'cordova-plugin-hms-site', // npm package name, example: cordova-plugin-camera
  pluginRef: 'HMSSite', // the variable reference to call the plugin, example: navigator.geolocation
  platforms: ['Android'] // Array of platforms supported, example: ['Android', 'iOS']
})
@Injectable()
export class HmsSite extends IonicNativePlugin {
