...
package com.huawei.hms.cordova.fcm;

import android.content.Intent;

import com.huawei.hms.cordova.fcm.basef.handler.CordovaController;
import com.huawei.hms.cordova.fcm.remote.FcmProxy;
...
public class HMSPushFcmProxy extends CordovaPlugin {

    private static final String KIT = "FCM";
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        cordovaController = new CordovaController(this, KIT, VERSION,
            Arrays.asList(new FcmProxy(webView.getContext())));
    }
