...
export class LangdetectPage {
  ...
  public async getlocalLangDetection() {
    ...
    try {
      var langDetectResult = await HMSMLLanguage.localLangDetection(localLangDetectionInput);
      alert(JSON.stringify(langDetectResult));
    } catch (ex) {
      alert(ex)
    }
  }
  ...
  public async firstBestLangDetection() {
    ...
    try {
      var langDetectResult = await HMSMLLanguage.remoteLangDetection(remoteLangDetectionInput);
