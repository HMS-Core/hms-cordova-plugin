...
async function remoteTranslator() {
    ...
    try {
        const result = await HMSMLLanguage.remoteTranslator(remotetranslateReq);
...
async function localTranslator() {
    ...
    try {
        const result = await HMSMLLanguage.localTranslator(localtranslateReq);
        document.getElementById("textView2").value = result;
    } catch (Ex) {
        alert(JSON.stringify(Ex));
    }
...
async function downloadlocal() {
    ...
    try {
        const result = await HMSMLLanguage.translatorDownloadModel(dowloadTranslateReq);
...
async function deletelocal() {
    ...
    try {
        const result = await HMSMLLanguage.translatorDeleteModel(deleteTranslateReq);
        alert(JSON.stringify(result));
    } catch (Ex) {
        alert(JSON.stringify(Ex));
    }
...
async function remoteAllLang() {
    ...
    try {
        const result = await HMSMLLanguage.translatorRemoteAllLang(remoteAllLangReq);
        alert(JSON.stringify(result));
    } catch (Ex) {
        alert(JSON.stringify(Ex));
    }
...
async function localAllLang() {
    ...
    try {
        const result = await HMSMLLanguage.translatorLocalAllLang(localAllLangReq);
        alert(JSON.stringify(result));
    } catch (Ex) {
        alert(JSON.stringify(Ex));
    }
