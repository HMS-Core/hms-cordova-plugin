...
function asrAnalyserStart() {
    var asrReq = {
        language: HMSMLPlugin.LANGUAGE.LAN_EN_US,
        feature: HMSMLPlugin.FEATURE.FEATURE_ALLINONE
    };
    document.getElementById('servicesDiv').style.backgroundColor = '#c4142c';
    HMSMLLanguage.asrAnalyser(
        asrReq,
        function (res) {
