...
@Plugin({
    pluginName: "HMSMLPlugin",
    plugin: "cordova-plugin-hms-mllanguage", // npm package name, example: cordova-plugin-camera
    pluginRef: "HMSMLPlugin", // the variable reference to call the plugin, example: navigator.geolocation
...
@Plugin({
    pluginName: "HMSMLLanguage",
    plugin: "cordova-plugin-hms-mllanguage", // npm package name, example: cordova-plugin-camera
    pluginRef: "HMSMLLanguage", // the variable reference to call the plugin, example: navigator.geolocation
    platforms: ["Android"], // Array of platforms supported, example: ['Android', 'iOS']
})
@Injectable()
