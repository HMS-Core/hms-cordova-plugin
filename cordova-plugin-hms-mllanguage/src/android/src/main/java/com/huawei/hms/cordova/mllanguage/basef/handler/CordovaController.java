...
package com.huawei.hms.cordova.mllanguage.basef.handler;
...
public class CordovaController {
        ...
        try {
            ...
            Log.e(TAG, String.format(Locale.ENGLISH,
                "When method %s in module %s was called 'Invocation Target Exception' occurred."
                    ...
                    + " Custom error message of the target exceptions is '%s.'", methodName, action,
    ...
    public void onRequestPermissionResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        for (String ref : moduleReferences) {
            groupHandler.getCordovaModuleHandler(ref)
                .getInstance()
