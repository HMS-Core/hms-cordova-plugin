...
package com.huawei.hms.cordova.mllanguage.helpers;
...
public class MLAsrConstant {
    ...
    public static final String LAN_TR_TR = "tr-TR";
    ...
    static {
        ...
        ASR_CONSTANTS_MAP.put(LAN_TR_TR, MLAsrConstants.LAN_TR_TR);
        ...
        ASR_CONSTANTS_MAP.put(LANGUAGE, MLAsrConstants.LANGUAGE);
