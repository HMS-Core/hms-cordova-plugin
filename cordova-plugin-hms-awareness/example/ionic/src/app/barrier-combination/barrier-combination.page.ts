...
@Component({
  selector: 'app-barrier-combination',
  templateUrl: './barrier-combination.page.html',
  styleUrls: ['./barrier-combination.page.scss'],
})
export class BarrierCombinationPage implements OnInit {
