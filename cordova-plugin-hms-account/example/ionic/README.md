...
5. Copy **hms-account** folder from **`node_modules/@hmscore/cordova-plugin-hms-account/ionic/dist`** directory to **`node_modules/@ionic-native`** directory.
...
3. Install `HMS Account Kit` to the project. You can either install the plugin through `npm` or by `downloading from HMS Core Plugin page`.
...
4. Copy **hms-account** folder from **`node_modules/@hmscore/cordova-plugin-hms-account/ionic/dist`** directory to **`node_modules/@ionic-native`** directory.
