...
function containScopes(authAccount, authScopeList, packageName) {
    return (0, utils_1.asyncExec)('HMSAccount', 'HMSAuthManager', ['containScopes', authAccount, authScopeList, packageName]);
}
