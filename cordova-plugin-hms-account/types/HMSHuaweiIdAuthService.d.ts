...
export declare function signIn(signInData: SignInData, packageName: String): Promise<AuthHuaweiId>;
export declare function signOut(): Promise<void>;
export declare function cancelAuthorization(): Promise<void>;
export declare function silentSignIn(authParams: AuthParams, packageName: String): Promise<AuthHuaweiId>;
