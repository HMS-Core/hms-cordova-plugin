...
package com.huawei.hms.cordova.mlbody.providers.faceverification;
...
import com.huawei.hms.cordova.mlbody.logger.HMSMethod;
import com.huawei.hms.cordova.mlbody.utils.HMSMLUtils;
import com.huawei.hms.cordova.mlbody.utils.PlatformUtils;
...
public class MLStillFaceVerificationAnalyser extends HMSProvider {
    ...
    public void initializeFaceVerification(final JSONObject params, final CallbackContext callbackContext)
        ...
        if (mlFaceVerificationAnalyserAnalyserSetting != null) {
            if (mlFaceVerificationAnalyserAnalyserSetting.has("MaxFaceDetcted")) {
