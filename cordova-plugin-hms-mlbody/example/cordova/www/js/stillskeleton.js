...
document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("getSkeletonAnalyserPicker").addEventListener("click", function () { getimgPicker(); });
...
async function stillskeletonnalyserStart() {
    ...
    try {
        alert(JSON.stringify(await HMSMLBody.stillSkeletonAnalyser(stillSkeletonReq)));
    } catch (Ex) {
