...
public class HMSSafetyDetectUtils {
    ...
    public static SysIntegrityRequest getSysIntegrityRequest(final JSONArray args) throws JSONException {
        SysIntegrityRequest sysIntegrityRequest = new SysIntegrityRequest();
        sysIntegrityRequest.setAlg(args.getString(2));
        sysIntegrityRequest.setAppId(args.getString(1));
        sysIntegrityRequest.setNonce(args.getString(0).getBytes(Charset.defaultCharset()));
        return sysIntegrityRequest;
    }
}
